"""Persist V3 Phase 2 safety research tables. Additive only.
...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("selected_experiment_id", sa.String(length=80), nullable=True),
        sa.Column("selected_safety_mechanism", sa.String(length=120), nullable=True),
        sa.Column("validation_metrics", sa.JSON(), nullable=True),
        sa.Column("development_replay", sa.JSON(), nullable=True),
