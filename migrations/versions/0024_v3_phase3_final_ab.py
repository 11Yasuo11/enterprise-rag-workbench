"""Persist V3 Phase 3 final frozen A/B tables. Additive only.
...
def upgrade() -> None:
    op.add_column(
        ...
        sa.Column("v3_phase3_dataset_id", sa.String(length=100), nullable=True),
    )
    op.create_table(
        "v3_phase3_experiment_locks",
    ...
    op.create_index(
        "ix_v3_phase3_experiment_locks_architecture_id",
        "v3_phase3_experiment_locks",
        ["architecture_id"],
    )
...
def downgrade() -> None:
    op.drop_index(
        "ix_v3_phase3_experiment_locks_architecture_id",
        table_name="v3_phase3_experiment_locks",
    )
    op.drop_table("v3_phase3_experiment_locks")
    op.drop_column("research_architecture_locks", "v3_phase3_dataset_id")
