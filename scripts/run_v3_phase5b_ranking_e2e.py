...
from rag_workbench.db.models import V3Phase5bExperimentRecord
from rag_workbench.db.session import session_factory
from rag_workbench.experiments.v3_phase5b_ranking_e2e import (
    LOCK_ID,
    V3Phase5bRankingBenchmark,
...
def main() -> None:
    ...
    with session_factory()() as session:
        benchmark = V3Phase5bRankingBenchmark(session)
        if phase == "preflight":
            ...
            record = session.get(V3Phase5bExperimentRecord, LOCK_ID)
